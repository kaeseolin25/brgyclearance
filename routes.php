...
$route['dashboard/viewall-brgyofficial'] = 'Backend_Controller/viewall_brgyofficial';


$route['dashboard/barangay-clearance'] = 'Backend_Controller/generate_pdf_form';
$route['dashboard/barangay-information'] = 'Backend_Controller/barangay_info';
$route['dashboard/barangay-settings'] = 'Backend_Controller/barangay_settings';
$route['dashboard/edit-brgysettings/(:num)'] = 'Backend_Controller/edit_brgysettings/$1';
 ...
 $route['dashboard/ajax-update-brgysettings-form']['post'] = 'Backend_Controller/ajax_update_brgysettings_form';

 /* New Route: Generate PDF Form */
 $route['dashboard/generate-pdf-form'] ['post'] = 'Backend_Controller/test';
